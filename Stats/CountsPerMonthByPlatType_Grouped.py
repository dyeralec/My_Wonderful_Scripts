...
output_spreadsheet = r"P:\05_AnalysisProjects_Working\Offshore Infrastructure and Incidents REORG\03_Analysis\Incidents\Incident Counts by Type\Struct_Weather_Incs_2008-2018_Stats_Grouped.csv"
type_field_index = 16
date_field_index = 0
date_format = '%m/%d/%Y'
beginning_year = 2008
