...
def writeResultsToCSV(platforms, outpath):
	...
	with open(outpath, 'w', newline='') as outfile:
		...
		for p in sPlats:
			print('Platform wind yearly max min: {}'.format(p.windYearlyMax_min))
...
if __name__ == "__main__":
	...
	platform_csv = r"C:\Users\dyera\Documents\Offshore Task 3\MEtocean\all_platforms_ver5_A_existing.csv"
	output_path = r"C:\Users\dyera\Documents\Offshore Task 3\MEtocean\hurricane_output_AllPlatforms_Ver5_A_completed_REDO_2_existing.csv"
