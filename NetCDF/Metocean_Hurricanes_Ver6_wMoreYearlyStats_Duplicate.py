...
class YearlyRecord(object):
	...
	def AddHit(self, cat, msws, mrwg, mcp):
		...
		if msws:
			self.MSWS_hit += 1
			print('new hits = {}'.format(self.MSWS_hit))
			...
			if region_storm[t][0] is not None:
				...
				if (platform.remove_date is None) and (timeObs >= platform.install_date):
					...
					if categ_hit is not None:
						...
						print('outside function MSWS hits = {}'.format(YearStats.MSWS_hit))
					continue
...
if __name__ == "__main__":
	...
	platform_csv = r"C:\Users\dyera\Documents\Offshore Task 3\MEtocean\all_platforms_ver5_B_existing.csv"
	output_path = r"C:\Users\dyera\Documents\Offshore Task 3\MEtocean\hurricane_output_AllPlatforms_Ver5_B_completed_REDO_2_existing.csv"
